...
## Purpose
Define how the app authenticates users (registration, login, passcode, biometric), manages sessions, and keeps SwiftUI authentication-state updates thread-safe and free of publishing violations.
## Requirements
